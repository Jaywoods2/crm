...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function chaxun(){
			$("#cstimg").attr("src","${pageContext.request.contextPath }/pages/~rept/jfreemakeup.action?condit="+$("#condit").val());
		}
	</script>
...
<div style="width:800px;margin:20px auto">
	 <img src="${pageContext.request.contextPath }/pages/~rept/jfreemakeup.action" width=800 height=400 border=0 id="cstimg">
	</div>
  </body>
</html>
